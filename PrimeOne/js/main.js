...
function adaptive_header(w,h) {
	...
	if(w<767){
		if(!$('.header-bottom__nav').hasClass('done')){
			$('.header-bottom__nav').addClass('done').appendTo(headerMenu);
		}
	}else{
		$.each($('.header-bottom__nav'), function(index, val) {
			if($(this).hasClass('header-bottom__nav_right')){
